...
agent.restore(directory='model_32',filename='agent-1')
...
"""
qsave(Omega1,'with_no_Omega1')
qsave(Delta1,'with_no_Delta1')
qsave(Omega2,'with_no_Omega2')
qsave(Delta2,'with_no_Delta2')
qsave(J,'with_no_J')
qsave(time,'with_no_time')

qsave(Omega1,'with_gauss_Omega1')
qsave(Delta1,'with_gauss_Delta1')
qsave(Omega2,'with_gauss_Omega2')
qsave(Delta2,'with_gauss_Delta2')
qsave(J,'with_gauss_J')
qsave(time,'with_gauss_time')

qsave(Omega1,'with_dropout_Omega1')
qsave(Delta1,'with_dropout_Delta1')
qsave(Omega2,'with_dropout_Omega2')
qsave(Delta2,'with_dropout_Delta2')
qsave(J,'with_dropout_J')
qsave(time,'with_dropout_time')
"""
