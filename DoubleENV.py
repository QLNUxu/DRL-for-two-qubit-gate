...
class YY(Environment):
    ...
    def __init__(self):
        ...
        self._max_episode_timesteps = 20 #100 pulses
        ...
        self.lam_Delta = 0#np.random.normal(0, 0.2)
        self.lam_Omega = 0#np.random.normal(0, 0.2)
    ...
    def reset(self):
        ...
        self.STATES=np.array([1, 0, 0, 0,  # real part of 1st row
                              ...
                              0, 0.5, 0, 0.5, 0.5, 0])# Omega1 Delta1 Omega2 Delta2 J t
        self.U = tensor(qeye(2),qeye(2))
